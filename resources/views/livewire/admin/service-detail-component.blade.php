<div>
    <div class="section-title-01 honmob">
        ...
        <div class="opacy_bg_02">
            <div class="container">
                <h1>{{ $service->name }} Detail</h1>
                <div class="crumbs">
                    <ul>
                        <li><a href="index.html">Home</a></li>
                        <li>/</li>
                        <li>{{ $service->name }} Detail</li>
                    </ul>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="post-content">
                                            ...
                                            <ul class="list-styles">
                                                @foreach (explode('|', $service->inclusion) as $inclusion)
                                                    <li><i class="fa fa-plus icon"></i>{{ $inclusion }}</li>
                                                @endforeach
                                            </ul>
                                            <h4>Exclusion</h4>
                                            <ul class="list-styles">
                                                @foreach (explode('|', $service->exclusion) as $exclusion)
                                                    <li><i class="fas fa-minus icon"></i>{{ $exclusion }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <aside>
                                ...
                                <div class="col-md-12 col-sm-6 col-xs-12 bg-dark color-white padding-top-mini"
                                    ...
                                    <a href="{{ route('service-detail', $related_services->slug) }}">
                                        <div class="img-hover">
                                            <img src="{{ asset('images/services/thumbnails/' . $related_services->thumbnail) }}"
                                        ...
                                        <div class="info-gallery">
                                            ...
                                            <hr class="separator">
                                            <p>{{ $related_services->name }}</p>
                                            <div class="content-btn"><a
                                                    href="{{ route('service-detail', $related_services->slug) }}"
                                                    class="btn btn-warning">View Details</a></div>
                                            <div class="price">
                                                <span>&#36;</span><b>From</b>{{ $related_services->price }}
                                            </div>
                                        </div>
                                    </a>
                                </div>
